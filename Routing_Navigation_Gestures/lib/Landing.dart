...
class Landing extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('CET373 - Mobile Technologies'),
      ),
      body: GridView.count(
          crossAxisCount: 2,
          childAspectRatio: 1,
  ...
  List<Widget> makeWidgets(BuildContext context) {
    final List<Map<String, dynamic>> listOfThings = <Map<String, dynamic>>[
      <String, dynamic>{
        'label': 'Drawer Navigation [Click on me]',
        'description':
      ...
      <String, dynamic>{
        'label': 'Stack Navigation [Click on me]',
        'description':
      ...
      <String, dynamic>{
        'label': 'Tab [Click on me]',
        'description':
            "A stationary set of tabs at the top or bottom of the widget that does not change but as a tab is pressed, the content changes.",
        'route': '/tab',
        'background': Colors.purpleAccent,
      },
      <String, dynamic>{
        'label': 'Dialog [Click on me]',
        'description':
            "Not technically navigation, but it shows a widget and then closing it. This could be considered a form of navigation.",
        'route': '/dialog',
